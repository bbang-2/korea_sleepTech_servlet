...
--%>
<%-- page 지시자: JSP 파일의 속정을 지정 (UTF-8로 인코딩)--%>
...
<%--    <p>안녕하세요, <%= name%>님</p>--%>
    ...
    <%--
        request.setAttribute("name", "yys");
        >>> (JSP에서 출력) <%= request.getAtribute("name")%>
    --%>
    <%-- EL(Expression Language)을 사용하여 조건식 처리: setAttribute를 총해 전달된 객체 참조 --%>
